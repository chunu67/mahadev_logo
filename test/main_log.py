...
#############################__________UP______########################################################   
    ...
    def up(self,**color):
        es=color['end_start']
        md=color['middle']
        mf=color['after_middle']            # Color $after_middle is used for modifing and define `md( middle colour )` 
        df=color['default']
        mod=color['mod']                     # Color $mod is used for modifing and define `md( middle colour )` 
